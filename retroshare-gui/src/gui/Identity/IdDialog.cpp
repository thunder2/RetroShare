    ...
    , ui(new Ui::IdDialog)
{
    ...
    mIdListModel->setFont(ui->idTreeWidget->font());

	mFontSizeHandler.registerFontSize(ui->idTreeWidget, 0, [this] (QAbstractItemView *view, int) {
		mIdListModel->setFont(view->font());
	});
